    ...
    void dangNhap() {
        ...
        if (nguoiDung != null) {
            ...
            if (nguoiDung.getVaiTro().equals("admin")) {
                AdminView adminView = new AdminView(scanner, auth, phongCtrl, nguoiDung,bookingController);
                adminView.menuAdmin();
            } else {
                UserView userView = new UserView(scanner, auth, phongCtrl, nguoiDung, bookingController);
