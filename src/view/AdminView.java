...
public class AdminView {
    ...
    void themKhuyenMaiView() {
        ...
        String ngayBatDauInput = scanner.nextLine();
        String ngayBatDau = ngayBatDauInput.isEmpty() ? null : ngayBatDauInput;

        System.out.print("Nhập ngày kết thúc (yyyy-MM-dd): ");
        String ngayKetThucInput = scanner.nextLine();
        String ngayKetThuc = ngayKetThucInput.isEmpty() ? null : ngayKetThucInput;
